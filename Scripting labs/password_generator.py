...
# and concatenates them into a single string. Your function should not accept any arguments and
...
def generate_password():
     new_pass=""
     for i in range(3):
         new_pass=new_pass+word_list[random.randint(0,len(word_list)-1)]
